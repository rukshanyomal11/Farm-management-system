          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-800">Farm Manager Dashboard</h1>
                  <p className="text-xs text-gray-600">Day-to-day operations management</p>
                </div>
              </div>
            </div>
      ...
      `}>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t bg-white">
          <div className="bg-blue-50 rounded-lg p-3">
            <p className="text-xs text-blue-800 font-semibold">👨‍🌾 Farm Manager</p>
            <p className="text-xs text-blue-600">Operations Access</p>
          </div>
        </div>
      </aside>
